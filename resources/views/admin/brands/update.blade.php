...
@section('title', $brand->detail()->where('locale', config('kakhura.site-bases.admin_editors_default_locale'))->first()->title)

@section('content')
    @include('vendor.site-bases.admin.inc.message')
    <div class="page-title">
        <div class="title_left">
            <h3>{{ $brand->detail()->where('locale', config('kakhura.site-bases.admin_editors_default_locale'))->first()->title }}</h3>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
                    ...
                    <div class="col-md-10 col-sm-12">
                        <form method="POST" action="" data-parsley-validate class="form-horizontal"  enctype="multipart/form-data">
                                    ...
                                    <div class="tab-pane {{ $localeCode == config('kakhura.site-bases.admin_editors_default_locale') ? 'active' : '' }}" id="{{ $localeCode }}">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10 col-sm-10  col-xs-12">
                                                <input type="text" name="title_{{ $localeCode }}" class="form-control" id="title_{{ $localeCode }}" value="{{ $brand->detail()->where('locale', $localeCode)->first()->title }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10 col-sm-10 col-xs-12">
                                                <textarea id="description_{{ $localeCode }}" class="textarea" name="description_{{ $localeCode }}">{{ $brand->detail()->where('locale', $localeCode)->first()->description }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10 col-sm-10  col-xs-12">
                                    <input type="text" name="video" class="form-control" id="video" value="{{ $brand->video }}">
                                </div>
                            </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="thumbnail">
                                                            <div class="image view view-first" style="height:260px">
                                                                <img src="{{ asset($brand->video_image) }}" >
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-offset-2 col-md-3 col-sm-4 col-xs-12">
                                    <label>
                                        <input type="checkbox" name="published" class="js-switch" {{ $brand->published ? 'checked' : '' }} />
                                        გამოქვეყნებულია
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-offset-2 col-md-3 col-sm-4 col-xs-12">
                                    <label>
                                        <input type="checkbox" name="show_on_brands" class="js-switch" {{ $brand->show_on_brands ? 'checked' : '' }} />
                                        გამოჩნდეს ბრენდებში
                                    </label>
                                </div>
                            </div>
                        ...
                        confirm: {
                            ...
                            action: function(){
                                $.ajax({
                                    ...
                                    url: '{{ url("admin/brands/delete-brand-img") }}',
                                    type: "post",
