                    ...
                    <div class="col-md-10 col-sm-12">
                        <form method="POST" action="" data-parsley-validate class="form-horizontal"  enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10 col-sm-10  col-xs-12">
                                    <input type="date" name="published_at" class="form-control" id="published_at" value="{{ $news->published_at->format('Y-m-d') }}">
                                </div>
                            </div>
                                ...
                                <div class="col-md-10 col-sm-10  col-xs-12">
                                    <select name="photo_id" class="form-control" id="photo_id">
                                        ...
                                        @foreach ($photos as $photo)
                                            <option {{ $news->photo_id == $photo->id ? 'selected' : '' }} value="{{ $photo->id }}">
                                                {{ $photo->title }}
                                            </option>
                                        @endforeach
                                    </select>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="thumbnail">
                                                            <div class="image view view-first" style="height:260px">
                                                                <img src="{{ asset($news->video_image) }}" >
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-offset-2 col-md-3 col-sm-4 col-xs-12">
                                    <label>
                                        <input type="checkbox" name="published" class="js-switch" {{ $news->published ? 'checked' : '' }} />
                                        გამოქვეყნებულია
                                    </label>
                                </div>
                            </div>
