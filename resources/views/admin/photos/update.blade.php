                    ...
                    <div class="col-md-10 col-sm-12">
                        <form method="POST" action="" data-parsley-validate class="form-horizontal"  enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10 col-sm-10  col-xs-12">
                                    <input type="date" name="published_at" class="form-control" id="published_at" value="{{ $photo->published_at->format('Y-m-d') }}">
                                </div>
                            </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="thumbnail">
                                                            <div class="image view view-first" style="height:260px">
                                                                <img src="{{ asset($photo->video_image) }}" >
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
